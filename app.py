...
job_link=st.text_area("Paste job URL or job description below", help="First try with the URL. If the tool is unable to scrape the site, please paste the job discription directly.")
